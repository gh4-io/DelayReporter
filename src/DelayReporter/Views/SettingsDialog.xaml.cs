...
namespace DelayReporter.Views
{
    ...
    public partial class SettingsDialog : Window
    {
        ...
        {
            get => SendOutlookWebRadio.IsChecked == true ? EmailClient.OutlookWeb
                 : SendOutlookComRadio.IsChecked == true ? EmailClient.OutlookCom
                 : EmailClient.MailApp;
            set
            {
                SendMailAppRadio.IsChecked = value == EmailClient.MailApp;
                SendOutlookWebRadio.IsChecked = value == EmailClient.OutlookWeb;
                SendOutlookComRadio.IsChecked = value == EmailClient.OutlookCom;
            }
        }
